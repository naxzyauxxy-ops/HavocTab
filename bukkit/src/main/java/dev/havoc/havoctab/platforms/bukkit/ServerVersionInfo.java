    ...
    private ImplementationProvider findImplementationProvider() {
        if (serverPackage != null) {
            ...
            try {
                ...
                return (ImplementationProvider) Class.forName("dev.havoc.havoctab.platforms.bukkit." + serverPackage + ".NMSImplementationProvider").getConstructor().newInstance();
            } catch (ReflectiveOperationException ignored) {
                throw new IllegalStateException(String.format(
                        "Your server version (%s - %s) is no longer supported. Please use an older version of HavocTab.",
        ...
        try {
            ...
            return (ImplementationProvider) Class.forName("dev.havoc.havoctab.platforms.bukkit." + implementation + ".NMSImplementationProvider").getConstructor().newInstance();
