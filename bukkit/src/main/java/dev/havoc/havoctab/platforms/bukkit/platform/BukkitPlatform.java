...
import dev.havoc.havoctab.platforms.bukkit.tags.BukkitActionBar;
import dev.havoc.havoctab.platforms.bukkit.tags.BukkitTagsMenu;
...
public class BukkitPlatform implements BackendPlatform {
    ...
    public void registerListener() {
        ...
        // Cosmetic tags menu, with tag feedback going above the hotbar rather than into chat
        BukkitTagsMenu tagsMenu = new BukkitTagsMenu(plugin);
        Bukkit.getPluginManager().registerEvents(tagsMenu, plugin);
        TagManager.setMenu(tagsMenu);
        TagManager.setActionBarSender(new BukkitActionBar());
