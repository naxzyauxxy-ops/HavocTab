package dev.havoc.havoctab.platforms.bukkit.provider;
...
/**
 * Interface for converting HavocTab components into NMS components (1.7+).
 *
 * @param   <T>
 *          NMS component type
 */
public abstract class ComponentConverter<T> {
    ...
    /**
     * Converts HavocTab component to NMS component.
     *
     * @param   component
