...
public class VelocityScoreboard extends SafeScoreboard<VelocityTabPlayer> {
    ...
    public void registerObjective(@NonNull Objective objective) {
        try {
            ...
            HavocTab.getInstance().getErrorManager().printError("Failed to register objective " + objective.getName() + " for player " + player.getName(), e);
        }
    }
    ...
    public void unregisterObjective(@NonNull Objective objective) {
        try {
            ...
            HavocTab.getInstance().getErrorManager().printError("Failed to unregister objective " + objective.getName() + " for player " + player.getName(), e);
        }
    }
    ...
    public void updateObjective(@NonNull Objective objective) {
        try {
            ...
            HavocTab.getInstance().getErrorManager().printError("Failed to update objective " + objective.getName() + " for player " + player.getName(), e);
        }
    }
    ...
    public void setScore(@NonNull Score score) {
        try {
            ...
            HavocTab.getInstance().getErrorManager().printError("Failed to set score " + score.getHolder() + " for player " + player.getName(), e);
        }
    }
    ...
    public void removeScore(@NonNull Score score) {
        try {
            ...
            HavocTab.getInstance().getErrorManager().printError("Failed to remove score " + score.getHolder() + " for player " + player.getName(), e);
        }
    }
    ...
    public void registerTeam(@NonNull Team team) {
        try {
            ...
            HavocTab.getInstance().getErrorManager().printError("Team " + team.getName() + " already existed with entry " +
    ...
    public void unregisterTeam(@NonNull Team team) {
        try {
            ...
            HavocTab.getInstance().getErrorManager().printError("Team " + team.getName() + " did not exist when unregistering for player " + player.getName(), e);
        }
    }
