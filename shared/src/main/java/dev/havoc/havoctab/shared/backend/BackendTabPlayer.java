...
import dev.havoc.havoctab.shared.TabConstants.Placeholder;
import dev.havoc.havoctab.shared.hook.ViaVersionHook;
...
public abstract class BackendTabPlayer extends TabPlayer {
    ...
    protected BackendTabPlayer(@NotNull BackendPlatform platform, @NotNull Object player, @NotNull UUID uniqueId,
        ...
        super(platform, player, uniqueId, name, HavocTab.getInstance().getConfiguration().getConfig().getServerName(),
