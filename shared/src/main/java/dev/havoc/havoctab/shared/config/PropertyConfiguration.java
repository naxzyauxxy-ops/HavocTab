...
public interface PropertyConfiguration {
    ...
    @NotNull
    List<String> VALID_PROPERTIES = Lists.newArrayList("tagprefix", "tagsuffix", "tabprefix", "customtabname", "tabsuffix", "chatprefix", "chatsuffix");
    ...
    default void checkProperty(@NonNull String source, @NonNull String type, @NonNull String name, @NonNull String property,
        ...
        if (startupWarn) {
            HavocTab.getInstance().getConfigHelper().startup().startupWarn(msg.toString());
        } else {
            HavocTab.getInstance().getConfigHelper().runtime().error(msg.toString());
        }
    }
}