...
import dev.havoc.havoctab.api.TabAPI;
...
import dev.havoc.havoctab.shared.command.DisabledCommand;
import dev.havoc.havoctab.shared.command.TabCommand;
import dev.havoc.havoctab.shared.config.Configs;
import dev.havoc.havoctab.shared.config.helper.ConfigHelper;
import dev.havoc.havoctab.shared.cpu.CpuManager;
import dev.havoc.havoctab.shared.data.DataManager;
import dev.havoc.havoctab.shared.event.EventBusImpl;
import dev.havoc.havoctab.shared.event.impl.TabLoadEventImpl;
 ...
 */
@Getter
public class HavocTab extends TabAPI {

    /** Instance of this class */
    @Getter
    private static HavocTab instance;
    ...
    public static void create(@NotNull Platform platform) {
        instance = new HavocTab(platform);
        instance.load();
    }

    /**
     * Constructs new instance with given parameters and sets this
     * new instance as {@link dev.havoc.havoctab.api.TabAPI} instance.
     *
     * @param   platform
     *          Platform interface
     */
    private HavocTab(@NotNull Platform platform) {
        ...
        // HavocTab: bStats metrics are disabled - this fork must not report data
        // under the upstream TAB project's bStats plugin IDs.
