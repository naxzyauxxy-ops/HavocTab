package dev.havoc.havoctab.shared.chat.hook;
...
public class AdventureObjectHook {
    ...
    /**
     * Converts HavocTab object component to adventure component
     *
     * @param   component
     *          Component to convert
     * @return  Adventure component from HavocTab component.
    ...
    /**
     * Converts adventure object component to HavocTab component
     *
     * @param   component
     *          Component to convert
     * @return  HavocTab component from adventure component.
     * @throws  UnsupportedOperationException
     *          If the object type is not supported
     */
    @NotNull
