...
public class Property {
    ...
    private void analyze(@NotNull String value) {
        ...
        for (String identifier : PlaceholderManagerImpl.detectPlaceholders(value)) {
            PlaceholderReference placeholder = HavocTab.getInstance().getPlaceholderManager().getPlaceholderReference(identifier);
    ...
    public String getFormat(@NotNull TabPlayer viewer) {
        ...
        for (String identifier : PlaceholderManagerImpl.detectPlaceholders(format)) {
            ...
            PlaceholderReference reference = HavocTab.getInstance().getPlaceholderManager().getPlaceholderReference(identifier);
    ...
    public String getOriginalReplacedValue() {
        ...
        for (String identifier : PlaceholderManagerImpl.detectPlaceholders(value)) {
            value = HavocTab.getInstance().getPlaceholderManager().getPlaceholderReference(identifier).getHandle().parse(owner);
        }
