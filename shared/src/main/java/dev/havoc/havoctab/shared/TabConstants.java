...
public class TabConstants {
    ...
    public static final String PLUGIN_MESSAGE_CHANNEL_NAME = "havoctab:bridge-6";
    ...
    public static class Permission {
        ...
        public static final String COMMAND_ALL                      = "havoctab.admin";
        public static final String COMMAND_RELOAD                   = "havoctab.reload";
        public static final String COMMAND_CPU                      = "havoctab.cpu";
        public static final String COMMAND_DEBUG                    = "havoctab.debug";
        public static final String COMMAND_DUMP                     = "havoctab.dump";
        public static final String COMMAND_GROUP_INFO               = "havoctab.groupinfo";
        public static final String COMMAND_GROUP_LIST               = "havoctab.grouplist";
        public static final String COMMAND_PARSE                    = "havoctab.parse";
        public static final String COMMAND_SETCOLLISION             = "havoctab.setcollision";
        public static final String COMMAND_AUTOCOMPLETE             = "havoctab.tabcomplete";
        public static final String COMMAND_DATA_REMOVE              = "havoctab.remove";
        public static final String COMMAND_PROPERTY_CHANGE_PREFIX   = "havoctab.change.";

        public static final String COMMAND_BOSSBAR_ANNOUNCE         = "havoctab.announce.bar";
        public static final String COMMAND_BOSSBAR_TOGGLE           = "havoctab.bossbar.toggle";
        public static final String COMMAND_BOSSBAR_TOGGLE_OTHER     = "havoctab.bossbar.toggle.other";

        public static final String COMMAND_MYSQL_DOWNLOAD           = "havoctab.mysql.download";
        public static final String COMMAND_MYSQL_UPLOAD             = "havoctab.mysql.upload";
        public static final String COMMAND_NAMETAG_VISIBILITY       = "havoctab.nametag.visibility";
        public static final String COMMAND_NAMETAG_VISIBILITY_OTHER = "havoctab.nametag.visibility.other";
        public static final String COMMAND_NAMETAG_VIEW             = "havoctab.nametag.view";
        public static final String COMMAND_NAMETAG_VIEW_OTHER       = "havoctab.nametag.view.other";

        public static final String COMMAND_SCOREBOARD_ANNOUNCE      = "havoctab.announce.scoreboard";
        public static final String COMMAND_SCOREBOARD_TOGGLE        = "havoctab.scoreboard.toggle";
        public static final String COMMAND_SCOREBOARD_TOGGLE_OTHER  = "havoctab.scoreboard.toggle.other";
        public static final String COMMAND_SCOREBOARD_SHOW          = "havoctab.scoreboard.show";
        public static final String COMMAND_SCOREBOARD_SHOW_OTHER    = "havoctab.scoreboard.show.other";

        public static final String STAFF                            = "havoctab.staff";
        public static final String GROUP_PREFIX                     = "havoctab.group.";
        public static final String PER_WORLD_PLAYERLIST_BYPASS      = "havoctab.bypass";
        public static final String SEE_VANISHED                     = "havoctab.seevanished";
        public static final String SPECTATOR_BYPASS                 = "havoctab.spectatorbypass";

        public static final String COMMAND_RANKS_TOGGLE             = "havoctab.ranks.toggle";
        public static final String COMMAND_CHAT_TOGGLE              = "havoctab.chat.toggle";
        public static final String COMMAND_CHAT_BLOCK               = "havoctab.chat.block";
        public static final String CHAT_MENTION                     = "havoctab.chat.mention";
        public static final String CHAT_BLOCK_BYPASS                = "havoctab.chat.blockbypass";
        public static final String COMMAND_BELOWNAME_TOGGLE         = "havoctab.belowname.toggle";

        public static final String TEST_PERMISSION                  = "havoctab.testpermission";
    }
    ...
    public static class Feature {
        ...
        public static final String CLIENT_DISPLAY = "ClientDisplaySettings";
        public static final String CHAT = "Chat";
        public static final String TABLIST_PAGES = "TablistPages";
    ...
    public static class Placeholder {
        ...
        // HavocTab client-side display toggles
        public static final String RANKS_VISIBLE = "%havoctab_ranks%";
        public static final String RANKS_VISIBLE_SHORT = "%ranks%";
        public static final String BELOWNAME_VISIBLE = "%havoctab_belowname%";
        public static final String BELOWNAME_VISIBLE_SHORT = "%belowname%";

        // HavocTab chat feature
        public static final String PUBLIC_CHAT_VISIBLE = "%havoctab_publicchat%";
        public static final String PUBLIC_CHAT_VISIBLE_SHORT = "%publicchat%";
        public static final String CHAT_FORMAT_VISIBLE = "%havoctab_chatformat%";
        public static final String CHAT_FORMAT_VISIBLE_SHORT = "%chatformat%";
        public static final String BLOCKED_COUNT = "%havoctab_blocked%";
        public static final String BLOCKED_COUNT_SHORT = "%blocked%";
        public static final String MENTIONS_ENABLED = "%havoctab_mentions%";
        public static final String MENTIONS_ENABLED_SHORT = "%mentions%";

        // Tablist pagination and tags
        public static final String TABLIST_PAGE = "%havoctab_page%";
        public static final String TABLIST_PAGES = "%havoctab_pages%";
        public static final String EQUIPPED_TAG = "%havoctab_tag%";
        public static final String EQUIPPED_TAG_SHORT = "%tag%";
        ...
        public static final Map<String, Integer> REFRESH_INTERVALS = new HashMap<String, Integer>() {{
            ...
            put(BEDROCK, -1);
            put(RANKS_VISIBLE, -1);
            put(RANKS_VISIBLE_SHORT, -1);
            put(BELOWNAME_VISIBLE, -1);
            put(BELOWNAME_VISIBLE_SHORT, -1);
            put(PUBLIC_CHAT_VISIBLE, -1);
            put(PUBLIC_CHAT_VISIBLE_SHORT, -1);
            put(CHAT_FORMAT_VISIBLE, -1);
            put(CHAT_FORMAT_VISIBLE_SHORT, -1);
            put(BLOCKED_COUNT, -1);
            put(BLOCKED_COUNT_SHORT, -1);
            put(MENTIONS_ENABLED, -1);
            put(MENTIONS_ENABLED_SHORT, -1);
            put(TABLIST_PAGE, -1);
            put(TABLIST_PAGES, -1);
            put(EQUIPPED_TAG, -1);
            put(EQUIPPED_TAG_SHORT, -1);
            put(COLLISION, 500);
            put(INVISIBLE, 500);
            put(TPS, 1000);
            put(MSPT, 1000);
    ...
    /**
     * HavocTab's custom metrics charts
     */
    @NoArgsConstructor(access = AccessLevel.PRIVATE)
