...
public class ChatPlayerData {
    ...
    /** If {@code true}, this player does not want to be pinged when someone mentions them */
    public volatile boolean mentionsDisabled;

    /** When this player last sent a message, for the chat filter's rate limit */
    public volatile long lastMessageTime;

    /** Recently sent messages in normalized form, newest first, for repeat detection */
    @NotNull
    public final java.util.Deque<String> recentMessages = new java.util.ArrayDeque<>();
