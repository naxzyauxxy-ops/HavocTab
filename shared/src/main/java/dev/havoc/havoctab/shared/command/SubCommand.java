...
public abstract class SubCommand {
    ...
    public void sendMessage(@Nullable TabPlayer sender, @NotNull String message) {
        ...
        if (sender != null) {
            ...
            HavocTab.getInstance().getPlatform().logInfo(TabComponent.fromColoredText(message));
        }
    }
    ...
    public void sendMessage(@Nullable TabPlayer sender, @NotNull TabComponent message) {
        if (sender != null) {
            ...
            HavocTab.getInstance().getPlatform().logInfo(message);
        }
    }
    ...
    public @NotNull MessageFile getMessages() {
        return HavocTab.getInstance().getConfiguration().getMessages();
    }
