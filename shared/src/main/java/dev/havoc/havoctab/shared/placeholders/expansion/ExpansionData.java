...
import dev.havoc.havoctab.shared.proxy.message.outgoing.ExpansionPlaceholder;
...
/**
 * Class holding data for HavocTab's PlaceholderAPI expansion for fast access.
 */
...
public class ExpansionData {
    ...
    /**
     * Sets client-side rank visibility placeholder to specified value.
     *
     * @param   visible
     *          Whether the player wants to see rank prefixes/suffixes or not
     */
    public void setRanksVisible(boolean visible) {
        setValue("ranks_visible", visible ? "Enabled" : "Disabled");
    }

    /**
     * Sets client-side belowname visibility placeholder to specified value.
     *
     * @param   visible
     *          Whether the player wants to see the belowname objective or not
     */
    public void setBelowNameVisible(boolean visible) {
        setValue("belowname_visible", visible ? "Enabled" : "Disabled");
    }

    /**
     * Sets public chat visibility placeholder to specified value.
     *
     * @param   visible
     *          Whether the player wants to receive public chat or not
     */
    public void setPublicChatVisible(boolean visible) {
        setValue("publicchat_visible", visible ? "Enabled" : "Disabled");
    }

    /**
     * Sets chat format visibility placeholder to specified value.
     *
     * @param   visible
     *          Whether the player wants the styled chat format or plain chat
     */
    public void setChatFormatVisible(boolean visible) {
        setValue("chatformat_visible", visible ? "Enabled" : "Disabled");
    }

    /**
     * Sets mention ping placeholder to specified value.
     *
     * @param   enabled
     *          Whether the player wants to be pinged when mentioned
     */
    public void setMentionsEnabled(boolean enabled) {
        setValue("mentions_enabled", enabled ? "Enabled" : "Disabled");
    }
    ...
    private void setValue(@NotNull String key, @NotNull String value) {
        data.put(key, value);
        if (player instanceof ProxyTabPlayer && HavocTab.getInstance().getConfiguration().getConfig().getPlaceholders().isRegisterTabExpansion()) {
