package dev.havoc.havoctab.shared.event;

import java.lang.reflect.Method;

import lombok.AllArgsConstructor;
import dev.havoc.havoctab.api.event.EventBus;
import dev.havoc.havoctab.api.event.EventHandler;
import dev.havoc.havoctab.api.event.Subscribe;
...
public class EventBusImpl implements EventBus {
    ...
    public <E extends TabEvent> void fire(E event) {
        ...
        HavocTab.getInstance().getErrorManager().errorFiringEvent(event, result.exceptions().values());
    }
