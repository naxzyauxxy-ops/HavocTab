package dev.havoc.havoctab.shared.chat.rgb;

import lombok.Getter;
import dev.havoc.havoctab.shared.chat.TabTextColor;
import dev.havoc.havoctab.shared.chat.rgb.format.BukkitFormat;
import dev.havoc.havoctab.shared.chat.rgb.format.CommonFormatter;
import dev.havoc.havoctab.shared.chat.rgb.format.RGBFormatter;
import dev.havoc.havoctab.shared.chat.rgb.gradient.CMIGradient;
import dev.havoc.havoctab.shared.chat.rgb.gradient.CommonGradient;
import dev.havoc.havoctab.shared.chat.rgb.gradient.GradientPattern;
import dev.havoc.havoctab.shared.chat.rgb.gradient.NexEngineGradient;
