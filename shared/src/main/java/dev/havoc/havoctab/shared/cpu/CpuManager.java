...
public class CpuManager {
    ...
    private final ThreadExecutor processingThread = new ThreadExecutor("HavocTab Processing Thread");

    /** Scheduler for placeholder refreshing task to prevent inefficient placeholders from lagging the entire plugin */
    private final ThreadExecutor placeholderThread = new ThreadExecutor("HavocTab Placeholder Refreshing Thread");

    /** Scheduler for refreshing permission groups */
    private final ThreadExecutor groupRefreshingThread = new ThreadExecutor("HavocTab Permission Group Refreshing Thread");

    /** Scheduler for checking for tablist entry values */
    private final ThreadExecutor tablistEntryCheckThread = new ThreadExecutor("HavocTab TabList Entry Checker Thread");

    /** Scheduler for encoding and sending plugin messages */
    @Getter
    private static final ThreadExecutor pluginMessageEncodeThread = new ThreadExecutor("HavocTab Plugin Message Encoding Thread");

    /** Scheduler for decoding plugin messages */
    private final ThreadExecutor pluginMessageDecodeThread = new ThreadExecutor("HavocTab Plugin Message Decoding Thread");

    /** Scheduler for MySQL tasks */
    private final ThreadExecutor mysqlThread = new ThreadExecutor("HavocTab MySQL Thread");
    ...
    /**
     * Submits task to HavocTab's main thread. If plugin is not enabled yet,
    ...
    /**
     * Runs a task in HavocTab's thread and measures how long it took to process.
     *
     * @param   feature
    ...
    /**
     * Runs a task in HavocTab's thread.
     *
     * @param   task
     *          Task to run
     */
