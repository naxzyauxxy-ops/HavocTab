 ...
 * any previous version of HavocTab to the current format.
 */
public class LegacyConverter {
    ...
    public void convert2810to290(@NonNull ConfigurationFile animations) {
        if (animations.getValues().size() == 1 && animations.getValues().containsKey("animations")) {
            HavocTab.getInstance().getPlatform().logInfo(new TabTextComponent("Performing configuration conversion from 2.8.10 to 2.9.0", TabTextColor.YELLOW));
    ...
    public void convert292to300(@NonNull ConfigurationFile currentConfig) throws IOException {
        ...
        HavocTab.getInstance().getPlatform().logInfo(new TabTextComponent("Performing configuration conversion from 2.9.2 to 3.0.0", TabTextColor.YELLOW));

        File folder = HavocTab.getInstance().getDataFolder();
        moveOldFiles();
    ...
    /**
     * Creates a new "old_configs" folder and moves all files in HavocTab's folder into it.
     *
     * @throws  IOException
    ...
    private void convertTeamOptions(@NonNull ConfigurationFile oldConfig, @NonNull ConfigurationFile newConfig, @Nullable ConfigurationFile premiumConfig) {
        ...
        if (HavocTab.getInstance().getPlatform().isProxy()) {
    ...
    private void convertBossBar(@NonNull ConfigurationFile bossBar, @NonNull ConfigurationFile newConfig) {
        ...
        String separator = HavocTab.getInstance().getPlatform().isProxy() ? "server" : "world";
    ...
    public void convert301to302(@NonNull ConfigurationFile config) {
        if (config.removeOption("placeholders.remove-strings")) {
            HavocTab.getInstance().getPlatform().logInfo(new TabTextComponent("Performing configuration conversion from 3.0.1 to 3.0.2", TabTextColor.YELLOW));
        }
    }
    ...
    public void convert332to400(@NonNull ConfigurationFile config) throws IOException {
        ...
        if (config.hasConfigOption("fix-pet-names")) {
            HavocTab.getInstance().getPlatform().logInfo(new TabTextComponent("Performing configuration conversion from 3.3.2 to 4.0.0", TabTextColor.YELLOW));
        ...
        File layoutFile = new File(HavocTab.getInstance().getDataFolder(), "layout.yml");
    ...
    public void convert409to410(@NonNull ConfigurationFile config) {
        if (config.hasConfigOption("yellow-number-in-tablist")) {
            HavocTab.getInstance().getPlatform().logInfo(new TabTextComponent("Performing configuration conversion from 4.0.9 to 4.1.0", TabTextColor.YELLOW));
    ...
    public void convert412to413(@NonNull ConfigurationFile config) {
        if (config.setIfMissing("placeholders.register-tab-expansion", false)) {
            HavocTab.getInstance().getPlatform().logInfo(new TabTextComponent("Performing configuration conversion from 4.1.2 to 4.1.3", TabTextColor.YELLOW));
        }
    }
    ...
    public void convert419to500(@NonNull ConfigurationFile config) {
        if (config.removeOption("scoreboard-teams.unlimited-nametag-mode")) {
            HavocTab.getInstance().getPlatform().logInfo(new TabTextComponent("Performing configuration conversion from 4.1.9 to 5.0.0", TabTextColor.YELLOW));
    ...
    public void convert501to502(@NonNull ConfigurationFile config) {
        if (config.rename("belowname-objective.number", "belowname-objective.value")) {
            HavocTab.getInstance().getPlatform().logInfo(new TabTextComponent("Performing configuration conversion from 5.0.1 to 5.0.2", TabTextColor.YELLOW));
        }
    ...
    public void convert507to510(@NonNull ConfigurationFile config) {
        if (config.rename("enable-redisbungee-support", "proxy-support.enabled")) {
            HavocTab.getInstance().getPlatform().logInfo(new TabTextComponent("Performing configuration conversion from 5.0.7 to 5.1.0", TabTextColor.YELLOW));
        ...
        config.setIfMissing("playerlist-objective.title", "HavocTab");
    ...
    public void convert521to522(@NonNull ConfigurationFile config) {
        if (config.removeOption("scoreboard-teams.anti-override")) {
            HavocTab.getInstance().getPlatform().logInfo(new TabTextComponent("Performing configuration conversion from 5.2.1 to 5.2.2", TabTextColor.YELLOW));
        }
