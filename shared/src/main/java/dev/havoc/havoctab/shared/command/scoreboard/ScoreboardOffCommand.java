...
/**
 * Handler for "/tab scoreboard off [player] [options]" subcommand
 */
public class ScoreboardOffCommand extends SubCommand {

    /**
     * Constructs new instance
     */
    public ScoreboardOffCommand() {
        super("off", TabConstants.Permission.COMMAND_SCOREBOARD_TOGGLE);
    }
