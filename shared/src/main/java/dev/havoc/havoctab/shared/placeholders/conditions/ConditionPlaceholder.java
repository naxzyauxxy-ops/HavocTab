...
public class ConditionPlaceholder {
    ...
    public ConditionPlaceholder(@NotNull String placeholderDefinition) {
        ...
        if (HavocTab.getInstance().getPlaceholderManager() != null) {
            this.realPlaceholder = HavocTab.getInstance().getPlaceholderManager().getPlaceholderReference(realPlaceholder);
        } else {
