...
public class DeserializableBungeeChannelDuplexHandler extends BungeeChannelDuplexHandler {
    ...
    static {
        try {
            ...
            HavocTab.getInstance().getErrorManager().criticalError("Failed to initialize bungee internal fields", exception);
        }
    }
    ...
    public void write(@NotNull ChannelHandlerContext context, @Nullable Object packet, @NotNull ChannelPromise channelPromise) {
        ...
        HavocTab.getInstance().getCPUManager().addTime(TabConstants.Feature.PACKET_DESERIALIZING, TabConstants.CpuUsageCategory.BYTE_BUF, System.nanoTime()-time);
